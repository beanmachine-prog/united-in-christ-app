...
import { Badge, Body, BrandMark, Button, Card, DemoNotice, Eyebrow, H1, H2, Hero, Muted, Row, Screen, SectionTitle } from '@/components/ui';
...
export default function Scripture() {
  ...
  return <Screen>
    ...
    <Card variant="accent">
      ...
      <Button label={saved ? 'Saved locally' : 'Save verse'} onPress={() => { setSaved(true); Alert.alert('Saved locally', 'Supabase syncing comes after auth setup.'); }} />
    </Card>
